...
ALTER TABLE "2024_raw" RENAME COLUMN Column10 TO Total_Arrivals;
ALTER TABLE "2024_raw" RENAME COLUMN Column13 TO Hotel_Arrivals;
ALTER TABLE "2024_raw" RENAME COLUMN Column20 TO Total_Nights;
ALTER TABLE "2024_raw" RENAME COLUMN Column23 TO Hotel_Nights;
ALTER TABLE "2024_raw" RENAME COLUMN "Regione / Region" TO Region;
ALTER TABLE "2024_raw" RENAME COLUMN "Provincia / Province" TO Province;
ALTER TABLE "2024_raw" RENAME COLUMN "Comune / Municipality" TO Municipality;
ALTER TABLE "2024_raw" RENAME COLUMN "Cod. Istat" TO ISTAT_code;

ALTER TABLE "2024_raw" DROP COLUMN "Cod. Reg";
ALTER TABLE "2024_raw" DROP COLUMN "Cod. Prov.";
ALTER TABLE "2024_raw" DROP COLUMN "flag";
ALTER TABLE "2024_raw" DROP COLUMN "Arrivi / Arrivals";
ALTER TABLE "2024_raw" DROP COLUMN Column9;
ALTER TABLE "2024_raw" DROP COLUMN Column11;
ALTER TABLE "2024_raw" DROP COLUMN Column12;
ALTER TABLE "2024_raw" DROP COLUMN Column14;
ALTER TABLE "2024_raw" DROP COLUMN Column15;
ALTER TABLE "2024_raw" DROP COLUMN Column16;
ALTER TABLE "2024_raw" DROP COLUMN Column17;
ALTER TABLE "2024_raw" DROP COLUMN "Presenze / Nights spent";
ALTER TABLE "2024_raw" DROP COLUMN Column19;
ALTER TABLE "2024_raw" DROP COLUMN Column21;
ALTER TABLE "2024_raw" DROP COLUMN Column22;
ALTER TABLE "2024_raw" DROP COLUMN Column24;
ALTER TABLE "2024_raw" DROP COLUMN Column25;
ALTER TABLE "2024_raw" DROP COLUMN Column26;

-- Remove unnecessary rows

DELETE FROM "2024_raw" WHERE "ISTAT_code" = '';
DELETE FROM "2024_raw" WHERE "Municipality" LIKE "Altri comuni%";
...
ALTER TABLE "2024_raw" ADD COLUMN ISTAT_code_clean TEXT;
ALTER TABLE "2024_raw" ADD COLUMN Hotel_Arrivals_clean INTEGER;
ALTER TABLE "2024_raw" ADD COLUMN Hotel_Nights_clean INTEGER;
ALTER TABLE "2024_raw" ADD COLUMN Total_Arrivals_clean INTEGER;
ALTER TABLE "2024_raw" ADD COLUMN Total_Nights_clean INTEGER;
...
ALTER TABLE "2024_raw" DROP COLUMN Hotel_Arrivals;
ALTER TABLE "2024_raw" DROP COLUMN Hotel_Nights;
ALTER TABLE "2024_raw" DROP COLUMN Total_Nights;
ALTER TABLE "2024_raw" DROP COLUMN Total_Arrivals;
ALTER TABLE "2024_raw" DROP COLUMN ISTAT_code;
...
-- Eventually, after adding a "Year" column to this final clean table, I can drop the old 2024_raw

ALTER TABLE "2024" ADD COLUMN Year INTEGER;
